...
(function() {
  ...
  class searchMovieComponent {
    ...
    FindMovie() {
      this.$http.get('https://api.themoviedb.org/3/search/movie?api_key=ab6dc310186e81db47b624603d5a9570&query=' + this.MovieName + '&year=' + this.Year).then(response => {
        console.log(response.data.results[0].id);
        var MovieID = response.data.results[0].id;
        this.$http.get('https://api.themoviedb.org/3/movie/' + MovieID + '?api_key=ab6dc310186e81db47b624603d5a9570').then(movieres => {
